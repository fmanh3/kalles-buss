...
export async function up(knex: Knex): Promise<void> {
  ...
  if (!await knex.schema.hasTable('technical_assets')) {
  ...
  if (!await knex.schema.hasTable('components')) {
  ...
  if (!await knex.schema.hasTable('inspections')) {
  ...
  if (!await knex.schema.hasTable('inspection_items')) {
